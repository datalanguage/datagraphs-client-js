...
function Concepts({ projectId, apiKey, clientId, clientSecret } = {}) {
   ...
   * @param {string|string[]} [options.ids] - List of concept ids to return
   * @param {string|string[]} [options.fields] - List of fields in to return in each concept
   ...
   * @param {string} [options.lang] - Two letter code for the language to return where multiple languages are available for a property. Use "all" to return all languages.
