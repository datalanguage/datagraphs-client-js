...
function Concepts({ projectId, apiKey, clientId, clientSecret } = {}) {
   ...
   * @param {string[]} [options.boosts] - List of properties in the format {property}:{weighting} where weighting is number between 0 and 100
   * @param {string[]} [options.fields] - List of fields in to return in each concept
